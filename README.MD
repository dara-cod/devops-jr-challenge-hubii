...
A validação de manifests Kubernetes não foi incluída na pipeline pois exigiria um cluster ativo no ambiente de CI. Como alternativa, os manifests foram testados localmente com k3d/minikube
